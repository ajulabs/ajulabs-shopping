...
export const PEDIDOS_MOCK: Pedido[] = [
  ...
  },
  {
    id: 'ped-002',
    lojaId: 'loja-002',
    lojaNome: 'Burguer do Bairro',
    consumidorId: 'user-001',
    itens: [
      { produto: PRODUTOS[3], quantidade: 1, precoUnitario: 32.90 },
    ],
    status: 'preparando',
    enderecoEntrega: USUARIO_MOCK.endereco!,
    subtotal: 32.90,
    ...
    estimativaEntrega: new Date(Date.now() + 30 * 60000).toISOString(),
  },
  {
    id: 'ped-003',
    lojaId: 'loja-001',
    ...
    consumidorId: 'user-001',
    itens: [
      { produto: PRODUTOS[1], quantidade: 1, precoUnitario: 18.90 },
    ],
    status: 'entregue',
    enderecoEntrega: USUARIO_MOCK.endereco!,
    subtotal: 18.90,
  ...
  },
  {
    id: 'ped-004',
    lojaId: 'loja-003',
    lojaNome: 'Mercadinho São João',
    consumidorId: 'user-001',
    itens: [
      { produto: PRODUTOS[4], quantidade: 3, precoUnitario: 8.50 },
    ],
    status: 'entregue',
    enderecoEntrega: USUARIO_MOCK.endereco!,
    subtotal: 25.50,
    ...
    atualizadoEm: new Date(Date.now() - 2 * 86400000 + 3600000).toISOString(),
  },
];
