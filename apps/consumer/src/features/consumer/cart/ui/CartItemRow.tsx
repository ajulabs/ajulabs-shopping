  ...
  return (
    <View style={styles.row}>
      ...
      <View style={styles.info}>
        <Text style={[styles.nome, { color: text }]} numberOfLines={2}>{item.produto.nome}</Text>
        <Text style={[styles.padrao, { color: textSec as string }]}>Padrão</Text>
...
const styles = StyleSheet.create({
  ...
  qtdBox:     { flexDirection: 'row', alignItems: 'center', borderWidth: 1,
                borderRadius: 99, paddingHorizontal: 4, paddingVertical: 2, gap: 8 },
