...
import { usePagamento } from '../model/usePagamento';
import { formatarNumero, formatarValidade } from '../lib/cartao';
  ...
  return (
    <View style={[styles.container, { backgroundColor: bg }]}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <Text style={[styles.secao, { marginTop: 20, color: textSec as string }]}>
          Cartões salvos
        </Text>
        ...
        {cartoes.length === 0 ? (
          ...
          cartoes.map((cartao) => (
            <View
              key={cartao.id}
              style={[styles.cartaoCard, { backgroundColor: surf, borderColor: border }]}
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={[styles.cartaoTitular, { color: textSec as string }]}>
                  {cartao.titular}
                </Text>
              </View>
              <TouchableOpacity
      ...
      <Modal visible={showModal} animationType="slide" presentationStyle="pageSheet">
        ...
        >
          <View style={[styles.modal, { backgroundColor: bg }]}>
            ...
            >
              <Text style={[styles.fieldLabel, { color: textSec as string }]}>
                Apelido do cartão
              </Text>
              <TextInput
                style={[
              ...
              <TextInput
                ...
                value={form.titular}
                onChangeText={(v) => setCampo('titular', v)}
              ...
              <TextInput
                ...
                value={form.numero}
                onChangeText={(v) => setCampo('numero', formatarNumero(v))}
              ...
              <View style={styles.row2}>
                <View style={{ flex: 1 }}>
                  ...
                  <TextInput
                    ...
                    value={form.validade}
                    onChangeText={(v) => setCampo('validade', formatarValidade(v))}
                    placeholder="MM/AA"
                    placeholderTextColor={textSec as string}
                    keyboardType="numeric"
                    maxLength={5}
                ...
                <View style={{ flex: 1, marginLeft: 12 }}>
                  ...
                  <TextInput
                    ...
                    value={form.cvv}
                    onChangeText={(v) => setCampo('cvv', v.replace(/\D/g, '').slice(0, 4))}
                    placeholder="000"
                    placeholderTextColor={textSec as string}
                    keyboardType="numeric"
                    maxLength={4}
              ...
              <View
                style={[
                  styles.aviso,
                  { backgroundColor: isDark ? 'rgba(255,255,255,0.05)' : colors.n50 },
                ]}
              >
...
const styles = StyleSheet.create({
  ...
  pixIconBox: {
    ...
    height: 40,
    borderRadius: 12,
    backgroundColor: 'rgba(0,198,94,0.1)',
    alignItems: 'center',
    justifyContent: 'center',
  },
