...
export const STATUS_META: Record<TicketStatus, { label: string; color: string; bg: string; icon: string }> = {
  ...
  resolvido:    { label: 'Resolvido',    color: '#16A34A', bg: '#DCFCE7', icon: 'checkmark-circle-outline' },
