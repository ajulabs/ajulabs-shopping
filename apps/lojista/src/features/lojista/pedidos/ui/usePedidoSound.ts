...
function tocarWebSom(tipo: SomTipo) {
  ...
  if (tipo === 'padrao') {
    ...
    bip(t + 0.0, 1050, 0.12, 0.9);
    bip(t + 0.18, 1050, 0.12, 0.9);
    bip(t + 0.36, 1050, 0.18, 0.9);
  } else if (tipo === 'rappi') {
    // Urgente: 5 bipes crescendo em frequência
    bip(t + 0.0, 800, 0.1, 0.7);
    bip(t + 0.14, 900, 0.1, 0.8);
    bip(t + 0.28, 1000, 0.1, 0.9);
    bip(t + 0.42, 1100, 0.1, 1.0);
    bip(t + 0.56, 1200, 0.2, 1.0);
  } else if (tipo === 'shopee') {
    // Duplo: par de bipes repetido 2x
    bip(t + 0.0, 1000, 0.1, 0.9);
    bip(t + 0.14, 1200, 0.1, 0.9);
    bip(t + 0.4, 1000, 0.1, 0.9);
    bip(t + 0.54, 1200, 0.15, 0.9);
  } else if (tipo === 'suave') {
    // Tom descendente suave mas audivel
    bip(t + 0.0, 1100, 0.25, 0.8);
    bip(t + 0.35, 900, 0.25, 0.7);
    bip(t + 0.7, 750, 0.35, 0.6);
  }
}
