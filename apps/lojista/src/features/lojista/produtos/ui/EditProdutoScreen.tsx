...
import {
  ...
  StyleSheet, ActivityIndicator, Alert, Image, Switch, Dimensions,
} from 'react-native';
...
const styles = StyleSheet.create({
  ...
  fieldLabelHint: { fontSize: 11, fontWeight: '400', color: colors.n500,
                    textTransform: 'none', letterSpacing: 0 },

  photoGrid:      { flexDirection: 'row', gap: 10 },
  photoSlotWrap:  { flex: 1 },
  photoSlot:      { width: SLOT_SIZE, height: SLOT_SIZE, borderRadius: 10,
  ...
  photoRemoveBtn: { position: 'absolute', top: 4, right: 4, width: 20, height: 20,
  ...
  saveBtn:        { height: 52, borderRadius: 14, backgroundColor: colors.orange,
