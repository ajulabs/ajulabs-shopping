...
const avaliacaoPedidoSpec = {
  name: 'POST_avaliacoes',
  input: {
    pedidoId: { required: true, type: 'string' },
    notaLoja: { required: true, type: 'number' },
    notaEntregador: { required: true, type: 'number' },
    avaliacoesProdutos: { required: true, type: 'array' },
    comentarioLoja: { required: false, type: 'string' },
    comentarioEntregador: { required: false, type: 'string' },
    tagsLoja: { required: false, type: 'array' },
    tagsEntregador: { required: false, type: 'array' },
  },
} as const;
...
router.post(
  ...
  authMiddleware,
  authUsuario,
  specValidatorMiddleware(avaliacaoPedidoSpec),
